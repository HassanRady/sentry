...
class ProjectCodeOwnersCreateRequestSerializer(serializers.Serializer[dict[str, object]]):
...
class ProjectCodeOwnersUpdateRequestSerializer(serializers.Serializer[dict[str, object]]):
    raw = serializers.CharField(
        required=False,
        help_text="The raw contents of the CODEOWNERS file.",
    )
